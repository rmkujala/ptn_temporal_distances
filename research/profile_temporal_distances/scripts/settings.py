...
ANALYSIS_START_TIME_DEP = ROUTING_START_TIME_DEP  + 3600  # 07:00
ANALYSIS_END_TIME_DEP = ROUTING_START_TIME_DEP + 12 * 3600

ROUTING_END_TIME_DEP = ROUTING_START_TIME_DEP + 14 * 3600
