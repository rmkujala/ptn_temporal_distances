...
ANALYSIS_START_TIME_DEP = ROUTING_START_TIME_DEP + 1 * 3600  # 07:00
ANALYSIS_END_TIME_DEP = ROUTING_START_TIME_DEP + 2 * 3600  # 08:00

ROUTING_END_TIME_DEP = ROUTING_START_TIME_DEP + 4 * 3600  # 10:00
