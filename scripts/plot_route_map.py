...
import numpy
from settings import FIGS_DIRECTORY, AALTO_STOP_ID, ITAKESKUS_STOP_ID, MUNKKIVUORI_STOP_ID
...
spatial_bounds = {
    ...
    "lat_min": numpy.percentile(lats, 4),
    "lat_max": numpy.percentile(lats, 96)
}
...
stop_lats = []
stop_lons = []
stop_Is = [AALTO_STOP_ID, ITAKESKUS_STOP_ID, MUNKKIVUORI_STOP_ID]
chars = "AIM"
